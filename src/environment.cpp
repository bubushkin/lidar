...
void simpleHighway(pcl::visualization::PCLVisualizer::Ptr& viewer)
{
    ...
    Lidar *izlidar = new Lidar(cars, 0.0);
    pcl::PointCloud<pcl::PointXYZ>::Ptr cloud = izlidar->scan();
    //renderRays(viewer, izlidar->position, cloud);
    renderPointCloud(viewer, izlidar->cloud, "point cloud");
